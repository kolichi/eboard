...
export class ProductDocumentKanbanControllerInherits extends KanbanController {
    setup() {
        super.setup();
...
ProductDocumentKanbanControllerInherits.template = `product.ProductDocumentKanbanView.inherit`;